...
## Missing notes
- Luo et al. 2024 reconstruction shift metric.
- DAA / Dual-Action and Attention dataset paper.
- FiLM / Perez et al.
- Soft modularization / Yang et al. 2020.
- Berthet et al. 2020 perturbed top-k.
- Kingma et al. 2016 free bits.
- Higgins et al. 2017 beta-VAE.
- BEHAVIOR_ENV reference (https://behavior.stanford.edu) — current Stanford VLA testing environment.
