Agenda:
1. Creating an Effective Prior
	1. Moving away from routing network
	2. Consider:
		1. Use 'Dorsal Stream' Image instead of line drawing to follow biological motivation of Active Vision
...
2. Evaluating Priors
	...
	2. Spatial Similarity to an 'Oracle Heatmap'
		1. Extract Spatial Locus of Attention
3. SURF -> SURG
